    ...
    return (
        <>
            <Styled.FormContainer>
                <Styled.CustomImage
                    src={`.${process.env.BACKEND_URL}/mersedes.png`}
                    alt='logo'
                />
                ...
                <Styled.RatingWrapper>
                    <img src={`.${process.env.BACKEND_URL}/yandex-logo.png`} width={76} height={22} alt='logo' />
                    <Stars />
                ...
                <Styled.DesktopWrapper>
                    <Styled.PartnerWrapper>
                        <img src={`.${process.env.BACKEND_URL}/shell.png`} width={92} height={24} alt='logo' />
